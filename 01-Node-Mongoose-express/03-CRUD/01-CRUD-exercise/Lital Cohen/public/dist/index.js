...
function handleGetImages() {
    return __awaiter(this, void 0, void 0, function () {
        var data, arrayOfImages, error, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios.get("/api/get-all-images")];
                case 1:
                    data = (_a.sent()).data;
                    arrayOfImages = data.arrayOfImages, error = data.error;
                    if (error)
...
function handleDeleteImage(imageId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, arrayOfImages, error, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios["delete"]("/api/delete-image", { data: { imageId: imageId } })];
                case 1:
                    data = (_a.sent()).data;
                    arrayOfImages = data.arrayOfImages, error = data.error;
                    console.log("ee");
