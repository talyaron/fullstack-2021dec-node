...
exports.getProduct = exports.addItem = void 0;
...
exports.addItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, year, url, itemDB, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, title = _a.title, year = _a.year, url = _a.url;
                itemDB = new ItemModel_1["default"]({ title: title, year: year, url: url });
...
exports.getProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userId, pictureDB, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                pictureDB = _a.sent();
                res.send({ success: true, user: user, pictures: pictureDB });
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
...
//     const pictureDB = new PictureModel({ title, year, url });
//     await pictureDB.save();
//     console.log(pictureDB);
//     await PictureModel.find({ ownerId: userId });
//     res.send({ success: true, user, pictures: pictureDB });
//   } catch (error) {
//     console.error(error);
