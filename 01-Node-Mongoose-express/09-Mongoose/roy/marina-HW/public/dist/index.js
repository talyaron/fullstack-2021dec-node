...
function handleRegister(e) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, data, user, error, error_1;
...
function handleLogin(e) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, data, user, login, error, entrances, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    e.preventDefault();
                ...
                case 2:
                    data = (_b.sent()).data;
                    user = data.user, login = data.login, error = data.error, entrances = data.entrances;
                    console.log(user);
