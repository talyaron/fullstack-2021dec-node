...
exports.handleRegister = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, name, password, img, error, user, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, email = _a.email, name = _a.name, password = _a.password, img = _a.img;
                error = UserModel_1.UserValidation.validate({ email: email, name: name, password: password, img: img }).error;
                if (error)
                    throw error;
                user = new UserModel_1["default"]({ email: email, name: name, password: password, img: img });
