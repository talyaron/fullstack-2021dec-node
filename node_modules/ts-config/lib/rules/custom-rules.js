...
if (semver_1.gte(tsLintVersion, '5.11.0')) {
    exports.customRules['file-name-casing'] = { options: ['kebab-case'] };
}
if (semver_1.gte(tsLintVersion, '5.12.0')) {
    exports.customRules['ban-ts-ignore'] = false;
    exports.customRules['no-default-import'] = false;
}
if (semver_1.gte(tsLintVersion, '5.18.0')) {
    exports.customRules['strict-comparisons'] = {
