...
<svg className='container' width="600px" height="400px" viewBox="30 27 529 286" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="graph-copy" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(30.000000, 27.000000)">
        ...
        <g id="grid" transform="translate(46.618321, 4.750000)" stroke="#FFFFFF" stroke-linecap="square" opacity="0.1">
