...
function handleRegister(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, name, age, img, error, user, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, email = _a.email, password = _a.password, name = _a.name, age = _a.age, img = _a.img;
                    error = UserModel_1.UserValidation.validate({ email: email, password: password, name: name, age: age, img: img }).error;
                    if (error)
                        throw error;
                    user = new UserModel_2["default"]({ email: email, password: password, name: name, age: age, img: img });
