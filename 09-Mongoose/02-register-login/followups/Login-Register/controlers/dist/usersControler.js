    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                error = UserModel_1.UserValidation.validate({ email: email, name: name, password: password }).error;
                if (error)
                    throw error;
                user = new UserModel_1["default"]({ email: email, name: name, password: password });
