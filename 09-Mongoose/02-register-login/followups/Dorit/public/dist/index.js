    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.post("/users/user-register", { name: name, email: email, password: password })];
                case 2:
                    data = (_a.sent()).data;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.post("/users/user-login", { name: name, email: email, password: password })];
                case 2:
                    data = (_a.sent()).data;
                    console.log(data);
                    login = data.login, error = data.error;
                    if (login)
                        alert("we found the user");
                    if (error) {
