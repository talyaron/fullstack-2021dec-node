...
var usersModel_2 = require("../model/usersModel");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    error = usersModel_2.UserValidation.validate({ email: email, password: password }).error;
                    if (error)
                        throw error;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (error)
                        throw error;
                    user = new usersModel_1["default"]({ email: email, password: password });
