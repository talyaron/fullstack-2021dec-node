    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios.get("/cats/get-kittens")
                        //const {docs}= data;
                    ];
                case 1:
                    data = (_a.sent()).data;
...
function searchKitten(event) {
    return __awaiter(this, void 0, void 0, function () {
        var age, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios.post("/cats/search-kitten", { age: age })];
                case 2:
                    data = (_a.sent()).data;
                    rendrReasult(data);
                    return [3 /*break*/, 4];
