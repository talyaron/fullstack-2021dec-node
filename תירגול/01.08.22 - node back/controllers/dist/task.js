...
exports.updateTask = exports.deleteTask = exports.saveTask = exports.getTasks = void 0;
...
exports.saveTask = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, desc, newTask, savedTask, tasks, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                newTask = new task_1["default"]({ title: title, description: desc });
                return [4 /*yield*/, newTask.save()];
            case 1:
                savedTask = _b.sent();
                if (!savedTask) return [3 /*break*/, 3];
                console.log("ok");
                return [4 /*yield*/, task_1["default"].find({})];
            case 2:
                tasks = _b.sent();
