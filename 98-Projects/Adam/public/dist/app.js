...
var _this = this;
var addToCart = function (ev, obj) {
    console.log(ev, obj);
};
window.addEventListener("load", function () { return __awaiter(_this, void 0, void 0, function () {
    var dbItems, itemsToRender, newItemContainer, items, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('loaded');
                return [4 /*yield*/, axios.get("/items?from_date=2022-05-20")];
            case 1:
                dbItems = _a.sent();
                ...
                newItemContainer = document.getElementById('items-container');
                if (newItemContainer) {
...
var addItemToCart = function () {
    console.log("i am item", _this);
    // increase cart number
    var cart = document.getElementById('cart');
    if (cart) {
        var counter = parseInt(cart.innerText);
        console.log(counter);
