...
let articles: Array<article> = [ { headline: 'מתן בלטקסה סיכם לשלוש שנים באוסטריה וינה, צפוי לחתום במועדון', Id: 'b',photo:'https://sport1images.maariv.co.il/image/upload/1099154', url: 'https://sport1.maariv.co.il/israeli-soccer/israelis-abroad/article/898010/', text: 'הבלם שסיים את חוזהו במכבי תל אביב כבר הגיע לבירת אוסטריה והשלים את הבדיקות הרפואיות לקראת הצטרפותו לקבוצה שסיימה את העונה במקום השלישי ותתמודד בפלייאוף הליגה האירופית.' }, 
{ headline: 'האקדמאי: מה יביא איתו יוריס ואן אובריים למכבי תל אביב?', Id: 'bc', photo:'https://sport1images.maariv.co.il/image/upload/1099093', url: 'https://sport1.maariv.co.il/magazine/article/897901/', text:'יוריס ואן אובריים חובב מתמטיקה ופיזיקה, מתעמק במשבר האקלים וצופה במשך שעות בכדורגל מכל העולם. האהבה שלו לעולמות חדשים הביאה אותו עד מכבי תל אביב ואחרי שביסס את מעמדו כשחקן לגיטימי בליגה ההולנדית, הוא ינסה להפוך לאינייסטה של ולאדן איביץ' },
{ headline: 'דסה: "מעריך את ההצעה ממכבי ת"א, אבל המטרה שלי להתקדם"', Id: 'cd', photo:'https://sport1images.maariv.co.il/image/upload/1099014', url: 'https://sport1.maariv.co.il/israeli-soccer/ligat-haal/article/897626/', text:'מגן נבחרת ישראל הודה: "מכבי תל אביב יודעת כמה אני אוהב ומכבד אותה, אבל בקרוב תדעו על עתידי ותהיו שמחים בשבילי". גם דור פרץ מסרב כרגע להתחייב לצהובים' } ];
