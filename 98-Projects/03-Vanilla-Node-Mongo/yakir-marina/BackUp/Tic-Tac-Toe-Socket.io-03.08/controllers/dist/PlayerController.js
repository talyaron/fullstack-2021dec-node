    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                lost = void 0;
                played = void 0;
                playerDB = new PlayerModel_1["default"]({
                    name: name,
                    email: email,
                    password: hash,
                    score: score,
...
exports.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                cookie = { playerId: playerDB._id, name: name };
                ...
                if (!playerDB) {
                    ...
                    res.send({ success: true, player: playerDB, entrances: entrances, score: score, lost: lost });
                }
                return [3 /*break*/, 4];
            case 3:
                error_2 = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, PlayerModel_1["default"].updateOne({ lost: lost, _id: playerID })];
            case 1:
                playerDB = _b.sent();
                // lost = playerDB.lost;
                res.send({ success: true, lost: lost, player: playerDB });
                console.log("lost is:", lost);
                console.log("playerDB", playerDB);
                return [3 /*break*/, 3];
            case 2:
...
exports.updateScoreByID = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, score, playerID, playerDB, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, score = _a.score, playerID = _a.playerID;
                return [4 /*yield*/, PlayerModel_1["default"].updateOne({ score: score, _id: playerID })];
            case 1:
                playerDB = _b.sent();
                res.send({ success: true, score: score, player: playerDB });
                console.log("score is:", score);
                console.log("playerDB", playerDB);
                return [3 /*break*/, 3];
            case 2:
