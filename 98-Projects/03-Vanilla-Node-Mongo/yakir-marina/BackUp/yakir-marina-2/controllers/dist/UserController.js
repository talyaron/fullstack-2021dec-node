...
exports.getPlayerByCookie = exports.login = exports.register = void 0;
...
exports.register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, error, salt, hash, playerDB, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                playerDB = new PlayerModel_1["default"]({ name: name, email: email, password: hash });
...
exports.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, error, playerDB, entrances, name, score, cookie, secret, JWTCookie, isMatchPassword, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
            ...
            case 2:
                ...
                cookie = { playerId: playerDB._id, name: name, score: score };
                ...
                if (!playerDB) {
                    ...
                    res.cookie("player", JWTCookie, { maxAge: 1000 * 60 * 3 });
...
exports.getPlayerByCookie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var player, secret, decodedCookie;
    return __generator(this, function (_a) {
        try {
            ...
            secret = process.env.JWT_SECRET;
            decodedCookie = jwt_simple_1["default"].decode(player, secret);
            console.log(decodedCookie);
            res.send({ success: true, player: player, decodedCookie: decodedCookie });
